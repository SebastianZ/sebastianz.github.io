import { CSSProperties, ReactNode, ElementType, Ref, ReactElement } from 'react';
import { FragmentAnimation, MarkdownConfig, RevealApi, RevealConfig, RevealPlugin, RevealPluginFactory, TransitionSpeed, TransitionStyle } from 'reveal.js';
...
export type SlideProps = React.HTMLAttributes<HTMLElement> & SlideDataAttributes & SlideBackgroundProps & SlideAutoAnimateProps & SlideRevealProps & {
    children?: ReactNode;
};
export type MarkdownOptions = Omit<MarkdownConfig, 'async' | 'separator' | 'verticalSeparator' | 'notesSeparator' | 'attributes'> & {
